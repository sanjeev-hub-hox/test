                  ...
                  <Grid key={index} item xs={3} sx={{ position: 'relative' }}>
                    ...
                    >
                      <CardContent sx={{ padding: '16px 16px 0 16px' }}>
                        ...
                        {(event?.event_type?.toLowerCase().includes('transfer') ||
                          event?.event_type?.toLowerCase().includes('reassign')) &&
                        event?.log_data &&
                          ...
                          >
                            {event?.log_data?.assigned_to && (
                              <Typography
                                ...
                                color='customColors.mainText'
                              >
                                <span className='icon-user' style={{ fontSize: '7px', marginTop: '2px' }}></span>
                                <span>Assigned to : {event?.log_data?.assigned_to}</span>
                              </Typography>
                            )}
                            {(event?.log_data?.previous_assigned_to_id || event?.log_data?.previous_assigned_to) && (
                              <Typography
                                variant='caption'
                                sx={{
                                  lineHeight: '1.2',
