          ...
          <CustomizerSpacing className='customizer-body'>
            ...
            <Box sx={{ mb: 4 }}>
              ...
              <RadioGroup
                row
                value={skin}
                onChange={(e, value) => handleChange('mode', value as Settings['mode'])}
          ...
          <CustomizerSpacing className='customizer-body'>
            ...
            <Box sx={{ mb: 4 }}>
              ...
              <RadioGroup
                row
                value={contentWidth}
                onChange={(e, value) => handleChange('contentWidth', value as Settings['contentWidth'])}
                sx={{ '& .MuiFormControlLabel-label': { fontSize: '.875rem', color: 'text.secondary' } }}
              >
            ...
            <Box sx={{ mb: 4 }}>
              ...
              <RadioGroup
                row
                value={appBar}
                onChange={(e, value) => handleChange('appBar', value as Settings['appBar'])}
                sx={{ '& .MuiFormControlLabel-label': { fontSize: '.875rem', color: 'text.secondary' } }}
              >
            ...
            <Box sx={{ mb: 4 }}>
              ...
              <RadioGroup
                row
                value={footer}
                onChange={(e, value)=> handleChange('footer', value as Settings['footer'])}
                sx={{ '& .MuiFormControlLabel-label': { fontSize: '.875rem', color: 'text.secondary' } }}
              >
                <FormControlLabel value='fixed' label='Fixed' control={<Radio />} />
                <FormControlLabel value='static' label='Static' control={<Radio />} />
            ...
            <Box sx={{ mb: 4, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              ...
              <Switch
                ...
                checked={appBarBlur}
                onChange={(e, checked) =>
                  handleChange('appBarBlur', checked)
                }
              />
            </Box>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              ...
              <Switch
                ...
                onChange={(e, checked)=> handleChange('direction', checked ? 'rtl' : 'ltr')}
              />
            </Box>
          </CustomizerSpacing>
            ...
            <Box sx={{ mb: layout === 'horizontal' && appBar === 'hidden' ? {} : 4 }}>
              ...
              <RadioGroup
                ...
                onChange={(e, value) => {
                  saveSettings({
                    ...settings,
                    layout: value as Settings['layout'],
                    lastLayout: value as Settings['lastLayout']
                  })
                }}
                sx={{ '& .MuiFormControlLabel-label': { fontSize: '.875rem', color: 'text.secondary' } }}
              >
            ...
            {navHidden || layout === 'horizontal' ? null : (
              <Box sx={{ mb: 4 }}>
                ...
                <RadioGroup
                  ...
                  onChange={(e, value)=>
                    handleChange('verticalNavToggleType', value as Settings['verticalNavToggleType'])
                  }
                  sx={{ '& .MuiFormControlLabel-label': { fontSize: '.875rem', color: 'text.secondary' } }}
                >
            ...
            {navHidden || layout === 'horizontal' ? null : (
              <Box sx={{ mb: 4, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <Switch
                  ...
                  onChange={(e, checked) => handleChange('navCollapsed', checked)}
                />
              </Box>
            )}
            ...
            {layout === 'horizontal' && appBar === 'hidden' ? null : (
              <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <Switch
                  name='navHidden'
                  checked={navHidden}
                  onChange={(e, checked)=> handleChange('navHidden', checked)}
                />
              </Box>
            )}
          </CustomizerSpacing>
