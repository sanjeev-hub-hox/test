...
export default function CreateCorporateTieUpMaster() {
  ...
  const validateForm = async () => {
    ...
    if (
      ...
      formData.corporateName.trim().length < 3 ||
      formData.corporateName.trim().length > 100
    ) {
    ...
    if (
      !formData.corporateDisplayName ||
      formData.corporateDisplayName.trim().length < 3 ||
      formData.corporateDisplayName.trim().length > 50
    ) {
