...
import { getObjectByKeyVal, getUserInfo } from '../../../utils/helper'
...
const FollowUpDialog = ({
  ...
  const [isBookedAgain] = useState<boolean>(false)
  const [reason] = useState<string>('Test Enquiry')
  const [isClosedEnquiry] = useState<boolean>(false)
  const [isRescheduled] = useState<boolean>(false)
                        ...
                        <Controller
                          ...
                          rules={{
                            ...
                            validate: value => {
                              ...
                              if (
                                selectedTime.isBefore(startTime, 'minute') ||
                                selectedTime.isAfter(endTime, 'minute')
                              ) {
