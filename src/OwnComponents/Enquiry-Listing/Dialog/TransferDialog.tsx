        ...
        <DialogContent>
          <Box sx={{ mb: 5, display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
            <Box sx={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'flex-start' }}>
              <Box sx={{ mr: 5 }}>
                <Image src={StudentLogo} alt='student Logo' width={100} height={100} />
              </Box>
              <Box>
                <Box sx={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center', flex: 1 }}>
                  <Box>
                    <Typography
                      ...
                      variant='subtitle1'
                      sx={{ mr: 6, lineHeight: '24px', fontWeight: '500' }}
                    >
                      Khevna Shah
                    </Typography>
                  </Box>
                  {chipsLabel.map((label, index) => (
                    <StyledChipProps key={index} label={label} color={'primary'} variant='filled' sx={{ mr: 4 }} />
                  ))}
                </Box>
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mt: 3 }}>
                  <Box>
                    <Typography variant='caption' color={'customColors.text3'} sx={{ lineHeight: '18px' }}>
                      Enquiry Type
                    </Typography>
                    <Typography
                      variant='body1'
