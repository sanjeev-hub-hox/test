...
export default function FilterComponent(props: FilterProps) {
  const { filterOpen, setFilterOpen, applyFilterOptions, academicYears, clearFilter, setFilteredColumns } = props
  // popover
  const handleClose = () => {
    setFilterOpen(null)
  }
  ...
  const [infoDialog] = useState(false)
  ...
  const [disbaleFilterInputValue] = useState(false)
