...
import { Button, Chip, Divider, Fab, IconButton, Popover, Tooltip, Typography } from '@mui/material'
...
function ManageRequest() {
  ...
  const [, setIsHighlighted] = useState<string>('')
    ...
    },
    {
      ...
      renderCell: () => {
        return (
          <>
            <Tooltip title='View'>
              <IconButton disableFocusRipple disableRipple onClick={() => handleView()}>
                {/* <EditIcon /> */}
                <span className='icon-eye'></span>
              </IconButton>
            </Tooltip>
            <Tooltip title='Edit'>
              <IconButton disableFocusRipple disableRipple onClick={() => handleEdit()}>
                <span className='icon-edit-2'></span>
              </IconButton>
            </Tooltip>
            <Tooltip title='Delete'>
              <IconButton disableFocusRipple disableRipple onClick={() => handleDelete()}>
