                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center', flex: 1 }}>
                  ...
                  {chipsLabel2.map((label, index) => (
                    <StyledChipProps
                      ...
                      variant='filled'
                      sx={{ mr: 4 }}
                      onDelete={label == 'Open' ? () => handleChipDelete() : undefined}
                      deleteIcon={
                        label == 'Open' ? (
                  ...
                  <Grid item container spacing={7} style={{ marginTop: '5px' }} xs={12} md={12}>
                    ...
                    <Grid item xs={12} md={4}>
                      <TextField
                        ...
                        onChange={e => {
                          ...
                          const error = checkValidationsZod([], val, 'pan')
                    ...
                    <Grid item xs={12} md={4}>
                      <TextField
                        ...
                        error={presentResidentAddress.length >= 200}
                        helperText={presentResidentAddress.length >= 200 ? 'Address should be less than 200 characters' : ''}
                      />
                    </Grid>
                    <Grid item xs={12} md={4}>
                      <TextField
                        ...
                        disabled
                        inputProps={{ maxLength: 200 }}
                        error={houseNo.length >= 200}
                        helperText={houseNo.length >= 200 ? 'Address should be less than 200 characters' : ''}
                      />
                    </Grid>
                    ...
                    <Grid item xs={12} md={4}>
                      <TextField
                        ...
                        disabled
                        inputProps={{ maxLength: 200 }}
                        error={streetName.length >= 200}
                        helperText={streetName.length >= 200 ? 'Address should be less than 200 characters' : ''}
                      />
                    </Grid>
                    <Grid item xs={12} md={4}>
                      <TextField
                        ...
                        inputProps={{ maxLength: 200 }}
                        error={landmark.length >= 200}
                        helperText={landmark.length >= 200 ? 'Address should be less than 200 characters' : ''}
                      />
                    </Grid>
                    <Grid item xs={12} md={4}>
                      <FormControl fullWidth>
