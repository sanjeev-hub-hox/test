...
const StyledChipProps = styled(Chip)(({ theme }) => ({
  '&.MuiChip-colorPrimary': {
    border: `1px solid d${theme.palette.primary.dark}`,
    borderRadius: '8px',
    height: '36px',
    padding: '6px 4px',
...
const NotificationDialog = ({ openDrawer, handleClose, title, userId, userType, notificationType }: SchoolTour) => {
          ...
          setVisibleItems(
            data.map((item: any) => {
              ...
              return {
                ...
                active: false,
                slug: item?.communication_master_slug
              }
            })
          )
        } else {
    ...
    <div>
      {openDrawer && (
        ...
        >
          ...
          >
            <Typography variant='subtitle1' color={'text.primary'} sx={{ lineHeight: '26px' }}>
              {title}
            </Typography>
            ...
            <>
              ...
              >
                <Box sx={{ mr: 3 }}>
                  ...
                  >
                    {content.active ? <span className='icon-info'></span> : <span className='icon-alarm'></span>}
                  </IconButton>
                </Box>
                <Box>
                  ...
                  >
                    <Typography variant='body2'>
                      {
                        // truncateText(content.body, expanded[index])
                        content.body
                      }{' '}
                    </Typography>
                    {/* <span
                  ...
                  <Typography variant='caption' mr={6}>
                    {content.timestamp}
                  </Typography>
                  {content?.attachment && (
                    <Typography variant='caption'>
                      <Link href={content?.attachment}>Attachment</Link>
                    </Typography>
                  )}
                </Box>
              </StyledBox>
