...
import { Button, DialogActions, DialogTitle, Grid, IconButton, TextField, CircularProgress } from '@mui/material'
...
function OnHoldDialog({ openModal, closeModal, header, workflowLogId, statusId }: customModal) {
  // ** Hooks
  ...
  const onSubmit = () => {
    ...
    postRequest({
      ...
      .catch(err => {
        toast.error('Failed to submit the form', err)
      })
      .finally(() => {
