...
import { Button, DialogActions, DialogTitle, Grid, CircularProgress, TextField } from '@mui/material'
...
function ApproveDialog({ openModal, closeModal, header, workflowLogId, statusId, userInfo }: customModal) {
  // ** Hooks
