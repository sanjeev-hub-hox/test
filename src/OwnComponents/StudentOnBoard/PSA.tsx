...
import { Autocomplete, Button, Checkbox, Chip, Grid, TextField, Tooltip, Typography } from '@mui/material'
...
export default function PSA({ school, payload, setCalculatedList, calculatedList }: any) {
  const {
    control,
    formState: { errors },
    watch
