...
import { Autocomplete, Button, Checkbox, Chip, Grid, TextField, Tooltip } from '@mui/material'
...
export default function SummerCamp({ school, payload, setCalculatedList, calculatedList }: any) {
  const {
    control,
    formState: { errors },
    watch
