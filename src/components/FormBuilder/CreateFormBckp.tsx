                          ...
                          <>
                            ...
                            formData?.[item?.['input_field_name']]?.length > 0 ? (
                              formData?.[item?.['input_field_name']]?.map((_text: any, inx: any) => (
                                <>
                                  <MultiSelectDropdown
                                    options={item?.['input_type_dropdown_options']?.map(() => ({
                                      ...item,
