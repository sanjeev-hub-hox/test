...
const EnquiryCorporateSource = ({ enquiryCorporateSource, handleChange, val, formData, setFormData }: any) => {
  ...
  useEffect(() => {
    ...
    const fetchOptions = async () => {
      try {
        ...
        const params = {
          url: `/api/ac-corporate-tie-ups?pagination[limit]=-1&filters[publishedAt][$notNull]=true&filters[mou_status][$eq]=1&filters[validity_end_date][$gte]=${today}&filters[validity_start_date][$lte]=${today}`,
          serviceURL: 'mdm',
          headers: {
