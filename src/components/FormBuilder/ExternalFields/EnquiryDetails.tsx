...
import { Autocomplete, Grid, TextField, CircularProgress, Box, Tooltip } from '@mui/material'
...
import { getCurrentYearObject, getObjectByKeyVal } from 'src/utils/helper'
...
export default function EnquiryDetails({
  ...
  const [defaultSchool] = useState<any>('')
  ...
  switch (ivtType) {
    ...
    case 'readmission_10_11':
      ...
      academicYearApiUrl =
        '/api/ac-academic-years?fields[1]=name&fields[2]=short_name&fields[3]=short_name_two_digit&fields[4]=is_visible&filters[is_visible][$eq]=1&filters[id][$notIn][0]=1&filters[id][$notIn][1]=2&filters[id][$notIn][]=3'
      break
    default:
  ...
  useEffect(() => {
    const fetchHostSchools = async () => {
      if (academicYear && schoolLocation && grade && course && board && stream && academicYearOptions.length > 0) {
        ...
        if (response?.status && response?.data?.data.length > 0) {
          ...
          handleChange('guest_student_details.location', null, validationArray, false, null, {
    ...
    <>
      ...
      <Grid item xs={4} md={4}>
        <CommonAutocomplete
          ...
          helperText={formData?.error?.['academic_year']}
          infoDialog={infoDialog}
          note={'Academic Year'}
        />
      </Grid>
      ...
      <Grid item xs={4} md={4}>
        <CommonAutocomplete
          ...
          helperText={formData?.error?.['school_location']}
          infoDialog={infoDialog}
      ...
      <Grid item xs={4} md={4}>
        <CommonAutocomplete
          ...
          helperText={formData?.error?.['student_details.grade']}
          infoDialog={infoDialog}
          note={'Grade'}
        />
      </Grid>
      <Grid item xs={4} md={4}>
        <CommonAutocomplete
          ...
          helperText={formData?.error?.['brand']}
          infoDialog={infoDialog}
          note={'Brand'}
        />
      </Grid>
      <Grid item xs={4} md={4}>
        <CommonAutocomplete
          ...
          helperText={formData?.error?.['board']}
          infoDialog={infoDialog}
          note={'Board'}
        />
      </Grid>
      <Grid item xs={4} md={4}>
        <CommonAutocomplete
          ...
          helperText={formData?.error?.['course']}
          infoDialog={infoDialog}
          note={'Course'}
        />
      </Grid>
      <Grid item xs={4} md={4}>
        <CommonAutocomplete
          ...
          helperText={formData?.error?.['stream']}
          infoDialog={infoDialog}
          note={'Stream'}
        />
      </Grid>
      ...
      <Grid item xs={4} md={4}>
        <CommonAutocomplete
          ...
          helperText={formData?.error?.['shift']}
          infoDialog={infoDialog}
          note={'Shift'}
        />
      </Grid>
