...
//     >
//       <>
//         <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start', flexWrap: 'nowrap' }}>
//           <Box
//             sx={{
//               // background: theme.palette.common.white,

//               width: !sidebar ? '96%' : '100%',
...
import { Navigation } from 'ampersand-common-ui-helper'
import { NavLayout } from "ampersand-common-ui-helper"
...
const UserLayout = ({ children, contentHeightFixed }: UserLayoutProps) => {
  ...
  return (
    <NavLayout
      ...
      HorizontalAppBarContent={HorizontalAppBarContent}
      Sidebar={Sidebar}
