...
const navigation = (): VerticalNavItemsType => {
  return [
    ...
    },
    {
      ...
      permissions: ['dashboard_request_management', 'dashboard_request_listing', 'request_listing_report'],
      serviceurl: 'marketing',
      children: [
        {
          title: 'Request Listing',
          path: '/request-listing',
          permission: 'dashboard_request_listing',
          serviceurl: 'marketing'
        },
        {
          title: 'Request Report',
          path: '/request-listing/report',
          permission: 'request_listing_report',
          serviceurl: 'marketing'
        },
      ]
    },
    ...
    {
      title: "Edulearn Documents",
      icon: "icon-document",
      permission: "edulearn_documents",
      path: "/edulearn/edulean-documents",
      serviceurl: "marketing",
    },
    {
      title: 'Logout',
